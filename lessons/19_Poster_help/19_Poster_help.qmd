...
- When I first ran the above, I got the following message: 
`The package "webshot2" is required to save gt tables as images. ✖ Would you like to install it? 1: Yes 2: No`
  - I inputted `1`
