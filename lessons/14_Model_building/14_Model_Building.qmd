...
2.  Perform our classification method on [training set]{style="color:#5B9BD5; font-weight: bold;"}
...
## Step 2: Fit LASSO: Main effects + interactions {visibility="hidden"}
...
## Step 2: Fit LASSO: Identify interactions {visibility="hidden"}
...
## Step 2: Fit LASSO: Create recipe and fit model (from LASSO) {visibility="hidden"}
