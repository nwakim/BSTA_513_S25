...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-important-color-frame, opacityback=0, arc=.35mm, coltitle=black, opacitybacktitle=0.6, breakable, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colback=white, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white]

Updates were made, but not quite at its final stage (Nicky 5/28)
...
\subsection{Things needed between Lab 4 and
Poster}\label{things-needed-between-lab-4-and-poster}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, opacityback=0, arc=.35mm, coltitle=black, opacitybacktitle=0.6, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The project report is a separate file from the labs}, colback=white, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-caution-color-frame, opacityback=0, arc=.35mm, coltitle=black, opacitybacktitle=0.6, breakable, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Important to keep in mind}, colback=white, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white]
