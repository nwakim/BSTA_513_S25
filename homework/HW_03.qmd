...
-   [Download the `.qmd` file here.](https://github.com/nwakim/BSTA_513_S25/blob/main/homework/HW_03.qmd)
...
Write a sentence interpreting the odds ratio for the **main effects** in the model from Part d. Please include the 95% confidence interval.
